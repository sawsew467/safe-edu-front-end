            ...
            <CardContent className="flex items-center justify-between p-6">
              <div className="space-y-1">
                ...
                <p className="text-2xl font-bold text-purple-900">
                  ...
                  <span className="text-sm font-normal">học viên đạt điểm</span>
                </p>
              </div>
...
function LeaderboardItem({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "grid grid-cols-12 items-center border-b border-gray-100 p-4 hover:bg-gray-50 transition-colors",
